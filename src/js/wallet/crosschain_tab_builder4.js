...
function crosschain_tab_builder4(div, selector){
    var ZERO = btoa(array_to_string(integer_to_array(0, 32)));
    //crypto to crypto exchange
    /*
      It starts with alice having 1 unit of btc and 1.2 veo. Bob has 1 unit of eth and 0.1 veo.

      Alice is the liquidity provider, Bob is the taker.

      Contract 1 is a buy veo contract, where Bob is buying veo using his eth.
      Contract 2 is a sell veo contract, where Bob is selling the veo to buy bitcoin.
     
Alice should only need to send her btc if she has already received the eth.
So contract 2 should be priced in contract 1 type 2, which is only valuable if the eth has already been delivered. 

        Timeline
* Bob publishes an offer to buy btc with his eth, He chooses the btc address where he wants to be paid.
* Alice accepts the offer. She chooses where she wants the eth to be delivered to.
* Bob sends the eth.
* Alice sends the btc
    ...
    title.innerHTML = "Crosschain Decentralized Exchange v2";
    ...
    */
    ...
    async function crosschain_offer(button){
        ...
        */
        ...
        //TODO. swap the order of the offers.
